...
const Parts = () => {
    return (
        <div className='bg-gradient-to-r from-cyan-300 to-blue-300 text-white my-32 p-6'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-3 px-16 py-4 '>
                <Link to="/epp">
                    <div class="card w-52 scale-100 hover:scale-110 bg-white hover:bg-primary text-primary-content">
                        <div class="card-body">
                ...
                <Link to="/epp">
                    <div class="card w-52 sc bg-white hover:bg-primary text-primary-content">
                        <div class="card-body">
                ...
                <Link to="/epp">
                    <div class="card w-52 bg-white hover:bg-primary text-primary-content">
                        <div class="card-body">

...
const OurLocations = () => {
    return (
        <div className=' my-36'>
            <h1 className='text-5xl font-serif py-8 underline underline-offset-8 '>We,At a Glance</h1>
            <div className=' grid grid-cols-1 lg:grid-cols-2 gap-10 py-8'>
                ...
                <div>
                    ...
                    <button className="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg my-2">See the map</button>
                </div>
            </div>
        </div>
